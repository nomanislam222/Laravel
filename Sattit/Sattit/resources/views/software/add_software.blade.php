										...
										<div class="row">
											...
											@endforeach
												...
												<div class="form-group">
													...
													<div class="col-lg-9">
														<textarea rows="5" cols="5" class="form-control" placeholder="Enter Feature Description In English" name="feature_des_e"></textarea>
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">Feature Description(Bangla):</label>
													<div class="col-lg-9">
														<textarea rows="5" cols="5" class="form-control" placeholder="Enter Feature Description In Bangla" name="feature_des_b"></textarea>
													</div>
												</div>
												<div class="form-group">
...
<p class="card-text">....</p>
        <!-- Img -->
													...
													<div class="col-lg-9">
                                                        <textarea class="form-control" id="summary-ckeditor" name="details_e"></textarea>
													</div>
												</div>
												<div class="form-group">
...
<p class="card-text">....</p>
        <!-- Img -->
													...
													<div class="col-lg-9">
                                                        <textarea class="form-control" id="bangla-ckeditor" name="details_b"></textarea>
													</div>
												</div>
													<div class="form-group">
