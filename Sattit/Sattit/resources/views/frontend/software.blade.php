...
<div class="col-md-8">
    ...
    <div class="tab-content" id="myTabContentMD" style="border:none">
        <div class="tab-pane fade show active" id="home-md" role="tabpanel" aria-labelledby="home-tab-md">
            <div class="card">
                <img class="card-img-top" src="{{asset('storage/'.$details->main_pic_e)}}" alt="Card image cap">
...
{!!$details->details_e!!}   
        ...
        <div class="tab-pane fade" id="profile-md" role="tabpanel" aria-labelledby="profile-tab-md">
            <div class="card">
                <img class="card-img-top" src="{{asset('storage/'.$details->main_pic_b)}}" alt="Card image cap">
                <div class="card-body text-center">
