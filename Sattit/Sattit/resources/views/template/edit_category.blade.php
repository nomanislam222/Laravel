...
@section('content')
		...
		<div class="col-md-8">
			<br>
			<h1 style="text-align: center;">Edit Web Template Category </h1>
							
								 <form method="POST" class="form-horizontal" action="{{url('template/update-category/'.$edit->category_id)}}">
                           {{ csrf_field() }}
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Web Template Category Form</h5>
