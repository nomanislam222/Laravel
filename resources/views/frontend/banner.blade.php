...
@section('content')
   ...
   @foreach($design as $des)
                <div class="col-md-4 my-2">
                    <a href="{{asset('storage/'.$des->pic)}}" class="gal_link"><img @if($des->title) title="{{$des->title}}" @endif src="{{asset('storage/app/public/'.$des->pic)}}" height="200px;" @if($des->alt) alt="{{$des->alt}}" @endif></a>
