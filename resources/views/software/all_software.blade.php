					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-button-html5-columns">
                            ...
                            <tr>
                                ...
                                <td><img height="100px" width="150px" src="{{asset('storage/app/public/'.$value->main_pic_e)}}"></td>
                                <td><img height="100px" width="150px" src="{{asset('storage/app/public/'.$value->icon_pic)}}"></td>
                                <td><img height="100px" width="150px" src="{{asset('storage/app/public/'.$value->feature_pic)}}"></td>
                                <?php
